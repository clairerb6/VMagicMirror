Shader "VMagicMirror/Universal Render Pipeline/MToon10 No Receive Shadow"
{
    // URP/MToon10の実装だとセルフ落影の見栄えがしっくり来ないのでセルフ落影だけ強制で消す改変を加えるshader
    Properties
    {
        // Rendering
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Intentionally omit shadow keywords so this shader keeps light direction
            // based MToon shading, but does not receive realtime shadows.
            ...
            #include "Packages/com.vrmc.vrm/MToon10/Shaders/vrmc_materials_mtoon_forward_vertex.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.vrmc.vrm/MToon10/Shaders/vrmc_materials_mtoon_depthonly_vertex.hlsl"
            #include "Packages/com.vrmc.vrm/MToon10/Shaders/vrmc_materials_mtoon_depthonly_fragment.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Packages/com.vrmc.vrm/MToon10/Shaders/vrmc_materials_mtoon_depthnormals_vertex.hlsl"
            #include "Packages/com.vrmc.vrm/MToon10/Shaders/vrmc_materials_mtoon_depthnormals_fragment.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Packages/com.vrmc.vrm/MToon10/Shaders/vrmc_materials_mtoon_shadowcaster_vertex.hlsl"
            #include "Packages/com.vrmc.vrm/MToon10/Shaders/vrmc_materials_mtoon_shadowcaster_fragment.hlsl"
            ENDHLSL
        }
